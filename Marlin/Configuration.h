...
#define STRING_CONFIG_H_AUTHOR "(puchisco, Ender-3 Pro)" // Who made the changes.
...
#define Z_SERVO_ANGLES { 135, 65 } // Z Servo Deploy and Stow angles
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -59.5, -19, -1.25 }
